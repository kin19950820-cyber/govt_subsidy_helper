...
津貼按香港政府常見受惠對象分類，方便唔同人士各取所需：

- **學生 / 在學家庭** — 書簿、車船、上網費、幼稚園學費減免
- **長者** — 長者生活津貼、高齡津貼（生果金）、長者醫療券、$2 乘車優惠
- **低收入 / 在職家庭** — 在職家庭津貼、綜援
- **殘疾人士** — 傷殘津貼
- **其他** — 預留擴充

`/schemes` 頁面有**受惠群組下拉選單**，`/finder` 問卷亦會按所選群組顯示對應問題。

> ⚠️ 長者 / 殘疾類津貼嘅金額、年齡及資產上限每年由政府公布，種子資料屬佔位並標示需人手核實，請以官方連結為準。

## 功能

1. **津貼配對問卷** `/finder` → `/results`：先揀受惠群組，再答群組相關問題，按信心分為「很可能適合 / 可能適合 / 未必適合 / 建議查詢社工」。
